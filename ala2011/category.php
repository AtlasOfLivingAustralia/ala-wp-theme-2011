...
get_header(); ?>
<div class="inner">
	<nav id="breadcrumb"><ol><li><a href="<?php echo get_option('home'); ?>">Home</a></li><li><a href="<?php echo get_permalink(24219);?>">Blogs &amp; news</a></li><li class="last"><?php single_cat_title(); ?></a></li></ol></nav>
	<h1>Blogs &amp; news / <?php single_cat_title(); ?></h1>
